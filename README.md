...
For support, please join our [community channel/discord] or raise an issue in the repository.
...
To add your own screenshots to this README, follow these steps:
...
- Use descriptive names (e.g., `home-screen.png`, `profile-view.png`)
- Optimize images for web viewing (compress if needed)

3. Reference images in README using either:

**Method 1: Relative Path (Recommended for Repository Images)**
```markdown
![Description](public/images/screenshots/your-image.png)
```

**Method 2: Direct URL (For External Images)**
```markdown
![Description](https://your-image-host.com/image.png)
```

4. For responsive images, use HTML syntax:
```html
<img src="public/images/screenshots/your-image.png" alt="Description" width="300"/>
```

5. For multiple images in a row:
```html
<div align="center">
